...
namespace Certweb
{
    public partial class Tarefas : UserControl
    {
        ...
        private void Executar(object _form)
        {
            ...
            ((Form1)_form).CertwebSystemTray.ShowBalloonTip(1000, "Certweb", Certweb.Armazenamento.Arquivo.Texto.MSG_SUCESSO_TAREFAS, ToolTipIcon.Info);
